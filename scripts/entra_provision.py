...
Needs var/run/graph_token.json from the device-code sign-in. Prints the .env lines to add.
Usage: .venv/bin/python scripts/entra_provision.py
"""
import json
import urllib.error
import urllib.parse
...
TOKEN = json.load(open("var/run/graph_token.json"))["access_token"]
