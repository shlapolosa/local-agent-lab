...
registration (the docx operating model). Creates:
  ...
  Entra (Microsoft Graph, token auto-refreshed from var/run/graph_token.json):
...
Usage: set -a && source .env && set +a && .venv/bin/python scripts/provision_visio_agents.py
"""
import json
import os
import urllib.parse
