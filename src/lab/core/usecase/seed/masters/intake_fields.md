...
|---|---|---|
| Effort table | Role, headcount, frequency per week, current minutes per instance, expected minutes per instance | Driver 1 |
| Quality baseline | Current volume, error rate, expected reduction, error class | Driver 2 |
| Sensitivity flags | Personal data, health data, financial, regulated | Driver 3 and the criticality band |
| Avoided cost citation | Specific avoided fine or audit-hour reduction, with its source | Driver 3, where quantified |
