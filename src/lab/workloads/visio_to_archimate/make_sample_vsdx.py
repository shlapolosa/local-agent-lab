...
The round-trip test input: `var/out/architecture/lab_model.json` (governance-plane view subset) →
...
Visio XML. Usage: `.venv/bin/python -m lab.workloads.visio_to_archimate.make_sample_vsdx`
"""
import json
import zipfile
...
LAB_MODEL = config.VAR_DIR / "out" / "architecture" / "lab_model.json"     # written by scripts/lab_model.py
OUT = config.VAR_DIR / "inputs" / "visio_to_archimate" / "lab-system.vsdx"
